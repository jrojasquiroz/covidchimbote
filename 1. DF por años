...
#1.Importamos el df
library(readr)
rawsinadef <- read_delim("C:/Users/rojas/Google Drive/Documentos personales/Covid-19 Chimbote/fallecidos_sinadef(13abril).csv", 
...
rm(muertes2021, muertes2021_2)
rm(muertes2020, muertes2020_2)
